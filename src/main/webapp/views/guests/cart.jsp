						...
						<tbody>
							...
							<c:forEach var="item" items="${ cart.getItems() }">
								...
								<tr>
									...
									<br> <img alt="" src="/image/${item.image}" width="70%"></td>
									<td>${ item.price.toString().replace(".0", " VNĐ") }</td>
									<td>
										<form action="/cart/update/${item.key}" method="post">
									...
									<td><a href="/cart/remove/${item.key}"><button
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							<tr>
								<td>Tạm Tính</td>
								<td align="right"><b>${ cart.amount.toString().replace(".0", " VNĐ") }</b></td>
							</tr>
							<tr>
								<td>Tổng Sản Phẩm</td>
						...
						<tfoot>
							<tr>
								...
								<td align="right">
									<h4>${ cart.amount.toString().replace(".0", " VNĐ") }</h4>
								</td>
							</tr>
						</tfoot>
					</table>
