...
<%--								alt="image" name="photo" width="150" height="250"  />--%>
<%--						</div>--%>
<%--						--%>
						...
						<div class="col-xs-10">
							<div class="form-group">
								...
								<form:input class="form-control form-control-large"
									id="username" path="username" placeholder="Enter Username" readonly="false"/>
							</div>
						</div>
						<div class="col-xs-10">
							<div class="form-group">
								...
								<form:input class="form-control form-control-small" id="pwd" type="password"
									path="password" placeholder="******" readonly="false"/>
							</div>
						</div>
						<div class="col-xs-10">
							<div class="form-group">
								...
								<form:input class="form-control" id="fullname" path="fullname"
									placeholder="Enter Fullname" readonly="false"/>
							</div>
						</div>
						...
						<div class="col-xs-10">
							<div class="form-group">
								...
								<form:input class="form-control form-control-small" id="email"
									path="email" placeholder="Enter email" readonly="false"/>
							</div>
						</div>
						<div class="col-xs-2"></div>
						<div class="col-xs-5">
