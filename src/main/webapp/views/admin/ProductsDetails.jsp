...
<div class="panel-group" >
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<div class="container">
				<form:form class="form-horizontal" action="/admin/product" id="image-form"
					modelAttribute="prod" enctype="multipart/form-data">
						<div class="col-sm-2">
							<img src="/image/${prod.image}" class="img-thumbnail" alt=""
								width="300" height="400">
						</div>
					<input type="file"  name="mulimage" accept="image/*" />
					...
					<br>
					<div class="input-group col-sm-10">
						<span class="input-group-addon" style="width: 3cm;"><b>Prices</b></span>
						<form:input type="text" class="form-control"
									path="prices" placeholder="Prices" />
					</div>
					<br>
					<div class="input-group col-sm-10">
						<span class="input-group-addon" style="width: 3cm;"><b>Total</b></span>
						<form:input type="text" class="form-control"
									path="total" placeholder="Price Product" />
					</div>
					<br>
					<div class="input-group col-sm-10">
					<div class="col-xs-5">
